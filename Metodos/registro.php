<?php 
	...
	$cargo2 = $_POST['cargodos'];
		...
		$con = conexion();
			...
			$ingresar ="INSERT INTO tbl_formato (folio_req, num_plaza, cordinacion, cod_umed, nom_umed, fecha_ini, fecha_con, dias_con, ref_requi, esp_otro, nom_cont, rfc, nom_asup, ise_clave, genero, nom_puesto, nivel, rango, horario_ent, horario_sal, turno, observaciones, clasi, dias_labo, fun_puesto, cono_req, exp_req, resp_cont_uno, resp_cont_dos, jefe_dep, titu_sub, titu_direc, cargo_uno, cargo_dos) values('$folioreq', '$numplaza', '$nomcord', '$codumed', '$nomumed', '$fechaini', '$fechacon', '$diascon', '$refrequi', '$espotro', '$nomcont', '$RFC', '$nomasup', '$iseclave','$sex', '$nompuesto', '$niv', '$rang', '$horaent', '$horasal', '$turn','$obser', '$clazz', '$diaslabo', '$funpuesto', '$conoreq', '$expreq','$resp1','$resp2','$jefe','$titu1','$titu2','$cargo1','$cargo2')";
